...
function c88990188.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local g1=Duel.SelectTarget(tp,c88990188.thfilter1,tp,LOCATION_MZONE,0,1,1,nil)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	local g2=Duel.SelectTarget(tp,c88990188.thfilter2,tp,0,LOCATION_ONFIELD,1,1,nil)
	g1:Merge(g2)
